...
def evaluate_on_file(power_model, file_path, device, epochs=50, lr=0.01, loss_plot_dir="test_loss_plots1", epoch_csv_dir="epoch_csv1", heatmap_dir="heatmaps1"):
    ...
    optimizer = optim.LBFGS([power_model.power_normalized], lr=lr, max_iter=20, history_size=10, line_search_fn='strong_wolfe')
...
output_csv = "test_results_summary1.csv"
